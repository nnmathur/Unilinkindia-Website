...
<body style="margin: 0px;">
    ...
    <p style="margin: 10px 10px 20px;padding-left: 40px;">New Enquiry.</p>
...
<tr>  
 ...
 <td width="105" height="22" align="left" valign="top" bgcolor="#3939a7" style="padding-left:10px;font-size:14px;color:#fff;padding-top:3px;padding-bottom:3px">Name :</td>  

 <td width="3" height="22" align="left" valign="top"></td>  

 <td height="22" align="left" valign="top" bgcolor="#CCCCCC" style="font-size:14px;color:#333;padding:3px 10px 5px 10px">{{ $name }}</td>  
