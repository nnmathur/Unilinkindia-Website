            ...
            <div class="row breadcrumbs-top d-inline-block">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('change_passsword') }}">Change Password</a>
                  </li>
				        ...
				        <div class="card">
				            ...
				            <div class="card-content collpase show">
				                <div class="card-body">
									...
									<form action="{{ route('changePasswordSuccessfully') }}" method="post" enctype="multipart/form-data" class="form form-horizontal">
										@csrf()
				                    		...
				                    		<div class="row">
				                    			<div class="col-md-6">
							                        <div class="form-group row">
							                        	<label class="col-md-3 label-control" for="userinput1">Old Password</label>
							                        	<div class="col-md-9">
							                            	<input type="password" name="cpassword" id="cpassword" placeholder="Enter Your Current Passsword" class="form-control border-primary" required="">
							                            </div>
							                        </div>
							                    </div>
							                </div>
					                        ...
					                        <div class="row">
					                        	<div class="col-md-6">
					                        		<div class="form-group row">
							                        	...
							                        	<div class="col-md-9">
															<input type="password" name="password_confirmation" id="password-confirm" placeholder="Enter Your Confirm Password" class="form-control border-primary" required="">
							                        	</div>
								                    </div>
					                        	</div>
					                        </div>
