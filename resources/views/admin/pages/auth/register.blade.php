                                ...
                                <div class="card-body">
                                    <form class="form-horizontal" action="{{ route('store') }}"  method="post">
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" class="form-control" id="user-name" name="name" placeholder="Your Username" required>
                                            <div class="form-control-position">
                                                <i class="ft-user"></i>
                                            </div>
                                        </fieldset>
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" class="form-control" id="user-name" name="email" placeholder="Your Email" required>
                                            <div class="form-control-position">
                                                <i class="fa fa-envelope-o"></i>
                                            </div>
                                        </fieldset>
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="number" class="form-control" id="user-name" name="contact" placeholder="Your Contact Number" required>
                                            <div class="form-control-position">
                                                <i class="ft-phone"></i>
                                            </div>
                                        </fieldset>
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="password" class="form-control" id="signinPwd" name="password" placeholder="Enter Password" required>
                                            <div class="form-control-position">
                                                <i class="fa fa-key"></i>
                                            </div>
                                            <div onclick="myFunction()" class="fa fa-eye" style="position: absolute; right: 10px; bottom: 13px;"></div>
                                        </fieldset>
                                        <button name="button" type="submit" class="btn btn-outline-info btn-block" tabindex="4">Register</button>
                                        <p class="mt-1">Already a member? <a href="{{ route('login') }}">Login</a></p>
                                    </form>
                                </div>
                            </div>
                        </div>
