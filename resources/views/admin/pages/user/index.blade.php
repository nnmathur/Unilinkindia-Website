            ...
            <div class="row breadcrumbs-top d-inline-block">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('auth.users.index') }}">Users List</a>
                  </li>
											...
											<td style="display: flex; border-bottom: none;">
												<form action="{{ route('deleteuser', $u->id) }}" method="POST">
										            ...
										            <a onclick="return confirm('Are you sure to Delete this file ?');" data-toggle="tooltip" data-placement="top" title="Delete">
										            	<button type="submit" class="btn btn-danger" name="userStatus" value="10"><i class="fa fa-trash"></i></button>
										            </a>
										        </form> 			
											</td>
