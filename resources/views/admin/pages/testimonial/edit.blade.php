...
if(isset($testimonialData))
{
    ...
    $short_description = $testimonialData->short_description;
    $image = $testimonialData->image;
    $designation = $testimonialData->designation;
    $facebook_url = $testimonialData->facebook_url;
    $twitter_url = $testimonialData->twitter_url;
    $linkedin_url = $testimonialData->linkedin_url;
    $instagram_url = $testimonialData->instagram_url;
}
        ...
        <div class="row breadcrumbs-top d-inline-block">
          <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="{{ route('auth.testimonial.index') }}">Testimonials</a>
              </li>
        ...
        <div class="col-md-12">
            <div class="form-group row">
                ...
                <div class="col-md-9">
                  ...
                  @if(trim($image))
                    <img src="{{ env('APP_URL')}}/storage/app/public/testimonial/{{ trim($image) }}" class="organisation-logo">
                  @else
