            ...
            <div class="row breadcrumbs-top d-inline-block">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('auth.clients.index') }}">Clients List</a>
                  </li>
	      							...
	      							<tbody>
	      								@if(count($clients) > 0)
											...
											<tr>
												...
												<td>
													@if($u->image)
									                    <img src="{{ asset('storage/app/public/clients/'.$u->image) }}" style="width: 100px; height: 70px;">
									                  @else
                                            	...
                                            	<td style="display: flex; border-bottom: none;">
                                            		<a href="{{ route('auth.clients.edit', $u->id) }}" onclick="return confirm('Are you sure to Edit this file ?');" data-toggle="tooltip" data-placement="top" title="Edit">
                                            			<button type="button" class="btn btn-primary"><i class="fa fa-pencil"></i></button>
                                            		</a>&nbsp;
                                            
                                                    <a href="{{ route('auth.clients.delete', $u->id) }}" onclick="return confirm('Are you sure to Delete this file ?');" data-toggle="tooltip" data-placement="top" title="Delete">
