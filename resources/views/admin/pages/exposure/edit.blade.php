        ...
        <div class="row breadcrumbs-top d-inline-block">
          <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="{{ route('auth.exposures.index') }}">Associates</a>
              </li>
					                    ...
					                    <div class="col-md-12">
				                        	<div class="form-group row">						
					    						...
					    						<div class="col-md-9">
							                        ...
							                        @if($bannerData->image)
							                        <img src="{{ asset('storage/app/public/exposures/'.$bannerData->image) }}" id="imagePreview" class="organisation-logo" alt="Your image will appear here.">
							                        @else
					                    ...
					                    <div class="col-md-12">
				                        	<div class="form-group row">
					                        	...
					                        	<div class="col-md-9">
							                        ...
							                        <a href="{{ asset('storage/app/public/exposures/'.$bannerData->attachment) }}" target="_blank">View Attachment</a>
							                    </div>
				                       		</div>
				                       	</div>
			                        </div>
