...
<div class="app-content content">
            ...
            <div class="row breadcrumbs-top d-inline-block">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('auth.blog.index') }}">Blogs List</a>
                  </li>
	      							...
	      							<tbody>
	      								@if(count($blogs) > 0)
											...
											<tr>
												...
												<td>
													@if($u->image)
									                    <img src="{{ env('APP_URL')}}/storage/app/public/blogs/{{ $u->image }}" style="width: 100px; height: 70px;">
									                  @else
	...
	<td style="display: flex; border-bottom: none;">
		<a href="{{ route('auth.blog.edit', $u->slug) }}" onclick="return confirm('Are you sure to Edit this Blog ?');" data-toggle="tooltip" data-placement="top" title="Edit">
			<button type="button" class="btn btn-primary"><i class="fa fa-pencil"></i></button>
		</a>&nbsp;

        <a href="{{ route('auth.blog.delete', $u->id) }}" onclick="return confirm('Are you sure to Delete this Blog ?');" data-toggle="tooltip" data-placement="top" title="Delete">
