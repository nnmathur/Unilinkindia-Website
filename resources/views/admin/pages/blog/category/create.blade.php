            ...
            <div class="row breadcrumbs-top d-inline-block">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('auth.blogcategory.create') }}">Add Blog Categories</a>
                  </li>
...
<div class="form-body">
	<h4 class="form-section"><i class="fa fa-eye"></i> About Blog Categories</h4>
	<div class="row">
		<div class="col-md-12">
