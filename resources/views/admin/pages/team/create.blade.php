            ...
            <div class="row breadcrumbs-top d-inline-block">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('auth.team.create') }}">Add Teams</a>
                  </li>
		...
		<div class="col-md-12">
            <div class="form-group row">
            	...
            	<div class="col-md-9">
                	...
                	<textarea id="userinput1" class="form-control border-primary" placeholder="Short Description" name="short_description"></textarea>
                </div>
            </div>
        </div>
    </div>
