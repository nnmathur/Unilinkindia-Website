...
<div class="app-content content">
            ...
            <div class="row breadcrumbs-top d-inline-block">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('auth.faq.index') }}">FAQ's List</a>
                  </li>
	...
	<td style="display: flex; border-bottom: none;">
		<a href="{{ route('auth.faq.edit', $u->id) }}" onclick="return confirm('Are you sure to Edit this FAQ ?');" data-toggle="tooltip" data-placement="top" title="Edit">
			<button type="button" class="btn btn-primary"><i class="fa fa-pencil"></i></button>
		</a>&nbsp;

        <a href="{{ route('auth.faq.delete', $u->id) }}" onclick="return confirm('Are you sure to Delete this FAQ ?');" data-toggle="tooltip" data-placement="top" title="Delete">
