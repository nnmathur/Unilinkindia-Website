...
if(isset($faqData))
{
	$id = $faqData->id;
	$title = $faqData->title;
  $short = $faqData->short_description; 
}
        ...
        <div class="row breadcrumbs-top d-inline-block">
          <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="{{ route('auth.faq.index') }}">FAQ's</a>
              </li>
          ...
          <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="horz-layout-colored-controls">FAQ's</h4>
...
<div class="form-body">
  <h4 class="form-section"><i class="fa fa-eye"></i> About FAQ's</h4>
    <div class="row">
      <div class="col-md-12">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">      
                    <textarea class="summernote" name="short_description">{{ $short }}</textarea>
                </div>
            </div>
        </div>
    </div>
