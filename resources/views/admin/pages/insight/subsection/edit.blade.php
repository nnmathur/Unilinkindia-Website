...
$inname = '';
if(isset($subsectionData))
{
	$inname = $subsectionData->name;
	$inpage = $subsectionData->page_id;
	$insection_id = $subsectionData->section_id;
	$indescription = $subsectionData->description;
}
	            ...
	            <div class="row breadcrumbs-top d-inline-block">
	                <div class="breadcrumb-wrapper col-12">
		                <ol class="breadcrumb">
		                    ...
		                    <li class="breadcrumb-item"><a href="{{ route('auth.insightsubsection.index') }}">Edit Sub-Sections</a></li>
				            ...
				            <div class="card-content collpase show">
				                <div class="card-body">
									...
									<form action="{{ $action }}" method="post" enctype="multipart/form-data" class="form form-horizontal">
				                    	...
				                    	<div class="form-body">
				                    		<h4 class="form-section"><i class="fa fa-eye"></i> Edit Sub-Sections</h4>
				                    		<div class="row">
							                    <div class="col-md-12">
						                        	<div class="form-group row">
							                        	<label class="col-md-3 label-control" for="userinput3">Sub-Section Title <span class="text-danger">*</span> :</label>
							                        	<div class="col-md-9">
							                            	<input class="form-control border-primary" type="text" placeholder="Sub-Section Title" id="userinput5" name="name" value="{{ trim($inname) }}" required="">
						                        		</div>
						                       		</div>
						                       	</div>
					                        </div>
					                        ...
					                        <div class="row">
							                    <div class="col-md-12">
						                        	<div class="form-group row">
							                        	...
							                        	<div class="col-md-9">
							                            	<select class="form-control" name="section_id" id="mainsection">
													        	@foreach($section as $k=>$c)
													        	    @if($c->id == $insection_id)
													        	        <option value="{{ trim($insection_id) }}" selected="">{{ $c->name }}</option>
													        	    @endif
													        	@endforeach
					                        ...
					                        <div class="row">
							                    <div class="col-md-12">
						                        	<div class="form-group row">
							                        	...
							                        	<div class="col-md-9">
							                            	<input class="form-control border-primary" type="text" placeholder="Description" id="userinput5" name="description" value="{{ trim($indescription) }}" required="">
						                        		</div>
						                       		</div>
						                       	</div>
					                        </div>
