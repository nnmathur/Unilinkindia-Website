...
$inname = '';
if(isset($knowledgeData))
{
	$inname = $knowledgeData->name;
	$inpage = $knowledgeData->page_id;
	$insection = $knowledgeData->section;
	$insub_section = $knowledgeData->sub_section;
	$indescription = $knowledgeData->description;
	$inattachment = $knowledgeData->attachment;
}
	            ...
	            <div class="row breadcrumbs-top d-inline-block">
	                <div class="breadcrumb-wrapper col-12">
		                <ol class="breadcrumb">
		                    ...
		                    <li class="breadcrumb-item"><a href="{{ route('auth.insightknowledge.index') }}">Edit Knowledge Bases</a></li>
				            ...
				            <div class="card-content collpase show">
				                <div class="card-body">
									...
									<form action="{{ $action }}" method="post" enctype="multipart/form-data" class="form form-horizontal">
				                    	...
				                    	<div class="form-body">
				                    		<h4 class="form-section"><i class="fa fa-eye"></i> Edit Knowledge Bases</h4>
				                    		<div class="row">
							                    <div class="col-md-12">
						                        	<div class="form-group row">
							                        	<label class="col-md-3 label-control" for="userinput3">Knowledge Base Title <span class="text-danger">*</span> :</label>
							                        	<div class="col-md-9">
							                            	<input class="form-control border-primary" type="text" placeholder="Knowledge Base Title" id="userinput5" name="name" value="{{ trim($inname) }}" required="">
						                        		</div>
						                       		</div>
						                       	</div>
					                        </div>
					                        ...
					                        <div class="row">
							                    <div class="col-md-12">
						                        	<div class="form-group row">
							                        	...
							                        	<div class="col-md-9">
							                            	<select class="form-control" name="section" id="mainsection">
													        	@foreach($section as $k=>$c)
													        	    @if($c->id == $insection)
													        	        <option value="{{ trim($insection) }}" selected="">{{ $c->name }}</option>
													        	    @endif
													        	@endforeach	
					                        ...
					                        <div class="row">
							                    <div class="col-md-12">
						                        	<div class="form-group row">
							                        	...
							                        	<div class="col-md-9">
							                            	<select class="form-control" name="sub_section" id="mainsub">
													        	@foreach($sub_section as $k=>$c)
													        	    @if($c->id == $insub_section)
													        	        <option value="{{ trim($insub_section) }}" selected="">{{ $c->name }}</option>
													        	    @endif
													        	@endforeach	
					                        ...
					                        <div class="row">
							                    <div class="col-md-12">
						                        	<div class="form-group row">
							                        	...
							                        	<div class="col-md-9">
							                            	<textarea name="description" rows="3" class="form-control border-primary" required="">{{ trim($indescription) }}</textarea>
						                        		</div>
						                       		</div>
						                       	</div>
					                        </div>
							                    ...
							                    <div class="col-md-12">
						                        	<div class="form-group row">
							                        	...
							                        	<div class="col-md-9">
									                        ...
									                        <a href="../../../storage/app/public/knowledgebase/{{ trim($inattachment) }}" target="_blank">View Attachment</a>
									                    </div>
						                       		</div>
						                       	</div>
					                        </div>
