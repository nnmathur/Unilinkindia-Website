	            ...
	            <div class="row breadcrumbs-top d-inline-block">
	                <div class="breadcrumb-wrapper col-12">
		                <ol class="breadcrumb">
		                    ...
		                    <li class="breadcrumb-item"><a href="{{ route('auth.insightsection.create') }}">Add Sections</a></li>
				            ...
				            <div class="card-content collpase show">
				                <div class="card-body">
									...
									<form action="{{ $action }}" method="post" enctype="multipart/form-data" class="form form-horizontal">
				                    	...
				                    	<div class="form-body">
				                    		<h4 class="form-section"><i class="fa fa-eye"></i> Add Sections</h4>
							                <div class="row">
							                    <div class="col-md-12">
					                        ...
					                        <div class="row">
							                    <div class="col-md-12">
						                        	<div class="form-group row">
							                        	...
							                        	<div class="col-md-9">
							                            	<input class="form-control border-primary" type="text" placeholder="Section Title" id="userinput5" name="name" required="">
						                        		</div>
						                       		</div>
						                       	</div>
					                        </div>
