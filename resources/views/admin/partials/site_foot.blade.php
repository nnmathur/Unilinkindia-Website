    ...
    <!-- END PAGE VENDOR JS-->
    <script src="{{ asset('assets/admin/vendors/js/extensions/moment.min.js') }}"></script>
    <script src="{{ asset('assets/admin/vendors/js/extensions/fullcalendar.min.js') }}"></script>
    <script src="{{ asset('assets/admin/js/core/libraries/jquery_ui/jquery-ui.min.js') }}"></script>
    ...
    <!-- END ROBUST JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="{{ asset('assets/admin/js/scripts/pickers/dateTime/pick-a-datetime.min.js') }}"></script>
    <script src="{{ asset('assets/admin/js/scripts/extensions/fullcalendar.min.js') }}"></script>
